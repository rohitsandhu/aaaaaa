...
<nav class="navbar navbar-expand-lg  mb-2 navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav text-uppercase mr-auto">
            ...
            <li class="nav-item mr-auto">
                <a class="btn-light btn " style="color: #6f42c1" href="shopWomen.php"> <strong> Women</strong></a>
            </li>
            <li class="nav-item mr-auto">
...
<div class="container-fluid mt-2" style="min-height: 80vh">
    <input type="hidden" name="sexe" id="sexe" value="dona">
    <div class="row">
        <div class="col-lg-2 my-4 bg-light m-3">
            <form class="mt-3">
                ...
                <div class=" d-flex justify-content-center my-2">
                    <a href="#" class="btn btn-light" onclick="getList()">Filter</a>
